    ...
    static dynamic_renders_routers(subMenus, mapping_routes, { with_switch, with_redirect, base_path = "" } = {}) {
        ...
        subMenus.forEach((v, i) => {
            if (!mapping_routes[v.page]) {
                ...
                const lazy_props = Object.assign({}, mapping_routes[v.page], { path: gen_path(mapping_routes[v.page].path, base_path) });
                ...
                const route_props = { location, children, path, exact, sensitive, strict };
                ...
                if (asroute_props.renderFactory === "render") {
                    routes.push(React.createElement(react_router_dom_1.Route, Object.assign({ key: i }, route_props, { render: (__route_props) => React.createElement(CAsyncRoute, Object.assign({}, Object.assign({}, asroute_props, __route_props))) })));
                }
                else {
        ...
        const path = gen_path(mapping_routes[subMenus[0].page].path, base_path);
